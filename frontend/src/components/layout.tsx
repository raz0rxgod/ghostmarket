          ...
          <CartProvider>
            <FavoritesProvider>
              <SiteEditModeProvider>
                <Header />
                {/* pb-16 компенсирует высоту фиксированной MobileNav (h-16),
                    иначе последний блок каждой страницы прятался бы под ней
                    на мобильном; на md+ MobileNav не рендерится, отступ снят */}
